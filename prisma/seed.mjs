...
async function main() {
  ...
  try {
    ...
    const cmsData = [
      ...
      { key: "hero_video_poster", value: "/images/hero-poster.png", section: "hero" },
      ...
      { key: "spotlight_video", value: "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4", section: "spotlight" },
