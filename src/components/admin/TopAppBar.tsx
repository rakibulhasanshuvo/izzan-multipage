...
export default function TopAppBar() {
  ...
  return (
    <header aria-label="Top Application Bar" className="sticky top-0 z-40 flex items-center justify-between px-4 md:px-10 ml-0 md:ml-[260px] w-full md:w-[calc(100%-260px)] h-20 bg-white/80 backdrop-blur-3xl border-b border-zinc-200/50 shadow-sm">
      <div className="flex items-center gap-2.5">
        <button
          aria-label="Toggle Sidebar"
          className="md:hidden text-zinc-500 hover:text-zinc-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-full p-2 mr-2"
      ...
      <div className="flex items-center gap-4 md:gap-6">
        <button aria-label="Notifications" className="relative text-zinc-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-full hover:text-zinc-900 transition-colors duration-300 flex items-center group hidden sm:flex">
