  ...
  return (
    <section id="story" className="py-24 px-6 md:px-12 max-w-[1600px] mx-auto scroll-mt-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center flex-col-reverse md:flex-row">
        ...
        >
          <Image src={imgUrl || "/images/story-workshop.png"} alt="Hand pouring candles" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" loading="eager" priority />
        </motion.div>
      </div>
    </section>
  );
